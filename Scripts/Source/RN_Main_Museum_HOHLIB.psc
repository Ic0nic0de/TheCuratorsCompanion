...
Event OnItemAdded (Form akBaseItem, Int aiItemCount, ObjectReference akItemReference, ObjectReference akSourceContainer)
	...
	if TCC_ItemList_Museum_1.HasForm(akBaseItem) && !TCC_FoundList_Museum_1.HasForm(akBaseItem) 
...
Event _onUpdate(string eventName, string strArg, float numArg, Form sender) ;;Automatic Call from (RN_Utility_Script)
	...
	If MCM.DevDebugVal
		DBMDebug.Log(GetOwningQuest(), "TCC: Update Event Completed for: Museum (HOH, Lib)")
	endIf
