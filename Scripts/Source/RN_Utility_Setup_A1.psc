...
function OnRunSetup_A1(string eventName, string strArg, float numArg, Form sender) ;;Runs Once, Automatic Call from (RN_Utility_Script)		
	...
	Debug.Trace("The Curators Companion: Setup Event Received for RN_Utility_Setup_A1")
	...
	RN_Setup_Done.Mod(1)
	Debug.Trace("The Curators Companion: Setup Event Completed for RN_Utility_Setup_A1")
endFunction
